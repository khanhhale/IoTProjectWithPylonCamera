   ...
   void SaveImage()  
   {
    ...
    try
    {
        ...
        // Saving images using the CImagePersistence class.
        {
            ...
            CPylonImage imageRGB16packed = SampleImageCreator::Createpylonimage( PixelType_RGB16packed, cWidth, cHeight);
            ...
            CImagePersistence::Save( ImageFileFormat_Tiff, "pylonimage.tiff", imageRGB16packed);
            ...
            imageRGB16packed.Save( ImageFileFormat_Bmp, "pylonimage.bmp");
        ...
        // Loading images.
        {
            ...
            CImagePersistence::Load( "pylonimage.tiff", imageRGB16packedFromTiff);
            ...
            imageBGR8packedFromBmp.Load( "pylonimage.bmp");
...
//JPEG handling is only supported on windows
        ...
        {
            // Create a sample image.
            CPylonImage imageRGB8packed = SampleImageCreator::Createpylonimage( PixelType_RGB8packed, cWidth, cHeight);
            ...
            // Save the image.
            CImagePersistence::Save( ImageFileFormat_Jpeg, "pylonimage_0.jpg", imageRGB8packed, &additionalOptions);

            // Set the highest quality value.
            additionalOptions.SetQuality(100);

            // Save the image.
            CImagePersistence::Save( ImageFileFormat_Jpeg, "pylonimage_100.jpg", imageRGB8packed, &additionalOptions);
        }
#endif
